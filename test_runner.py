import unittest
from tests import (test_fastq_reader,
                   test_integration,
                   test_fastq_obj,
                   test_fastq_writer,
...
demultiplex_integration_test_suite.addTest(unittest.defaultTestLoader.loadTestsFromModule(test_integration))

# run the unit/integration tests
unittest.TextTestRunner(verbosity=2, descriptions=False).run(demultiplex_unit_test_suite)
# unittest.TextTestRunner(verbosity=2, descriptions=False).run(demultiplex_integration_test_suite)
